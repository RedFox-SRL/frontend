...
export default function SprintHeader({ sprints, currentSprint, onSprintChange, onNewSprintClick, onNewTaskClick }) {
    return (
        <div className="bg-purple-600 p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                ...
                <div className="flex flex-wrap gap-2">
                    <Button variant="secondary" className="bg-white text-purple-600 hover:bg-purple-100" onClick={onNewSprintClick}>
                    ...
                    <Button variant="secondary" className="bg-purple-500 text-white hover:bg-purple-400" onClick={onNewTaskClick} disabled={!currentSprint}>

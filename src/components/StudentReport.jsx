...
export default function StudentReport() {
    return (
        <div className="container mx-auto p-4 sm:p-6 bg-purple-50 min-h-screen">
            ...
            <Card className="mb-6">
                <CardHeader>
                    <CardTitle className="text-purple-700 text-lg sm:text-xl font-semibold">Autoevaluación: Sprint X</CardTitle>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                        {/* Columna 1: ¿Qué hice bien? */}
                        <div className="bg-purple-100 rounded-lg p-4">
                            <h3 className="text-purple-700 font-bold text-lg mb-4">¿Qué hice bien?</h3>
                            <div className="space-y-2 mb-4">
                                <Card className="p-2 bg-white">
                                    <p className="font-semibold text-gray-700">Puntualidad en las reuniones</p>
                        ...
                        <div className="bg-purple-100 rounded-lg p-4">
                            <h3 className="text-purple-700 font-bold text-lg mb-4">¿Qué hice mal?</h3>
                            <div className="space-y-2 mb-4">
                                <Card className="p-2 bg-white">
                                    <p className="font-semibold text-gray-700">Mala distribución del trabajo</p>
                                    <p className="text-sm text-gray-500">Descripción</p>
                                    <p className="text-xs text-gray-400">Creado por: Diego</p>
                                </Card>
                                {/* Espacio para agregar más elementos */}
                        ...
                        <div className="bg-purple-100 rounded-lg p-4">
                            <h3 className="text-purple-700 font-bold text-lg mb-4">¿Qué puedo mejorar?</h3>
                            <div className="space-y-2 mb-4">
                                <Card className="p-2 bg-white">
                                    <p className="font-semibold text-gray-700">Mejorar la distribución del trabajo</p>
                                    <p className="text-sm text-gray-500">Descripción</p>
                                    <p className="text-xs text-gray-400">Creado por: Diego</p>
                                </Card>
                                {/* Espacio para agregar más elementos */}
                ...
                <div className="flex justify-center p-4">
                    <Button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold text-md px-8 py-2 rounded-md">Enviar autoevaluación</Button>
                </div>
            </Card>
        </div>
    );

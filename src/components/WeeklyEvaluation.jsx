...
export default function WeeklyEvaluation({groupId}) {
    ...
    return (<div className="p-4 mx-auto space-y-6 max-w-full">
        ...
        {sprintEnded && (<Card className="bg-purple-100 border-purple-300 shadow-md">
            <CardContent className="flex items-center justify-center p-6">
                <svg
                ...
                <div>
                    ...
                    <p className="text-purple-700">
                        No se pueden crear evaluaciones semanales después de la fecha de finalización del
                        sprint.
                    </p>
                </div>
            </CardContent>
        ...
        {template && (<>
            {isEvaluated ? (<Card>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-purple-600">Reporte semanal -
                            Semana {template.week_number}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold mb-2 text-purple-700">Estado de
                                    Participación</h3>
                                <ResponsiveContainer width="100%" height={250}>
                                    <PieChart>
                                        ...
                                        >
                                            {taskData.map((entry, index) => (<Cell key={`cell-${index}`}
                ...
                <div className="space-y-4">
                    ...
                    {template.tasks.map(task => (<Card key={task.id}>
                        <CardContent className="p-6">
                            ...
                            {task.links.length > 0 && (<div className="mb-4">
                                <h4 className="text-purple-500 font-semibold mb-2">Links:</h4>
                                <ul className="list-disc list-inside">
                                    {task.links.map(link => (<li key={link.id}>
        ...
        <Dialog open={isHelpDialogOpen} onOpenChange={setIsHelpDialogOpen}>
            <DialogContent>
                ...
                <ul className="list-disc list-inside ml-4">
                    ...
                    <li>Recuerda: Solo puedes evaluar los avances semanales antes de que termine el sprint. Una vez
                        finalizado el sprint, no se podrán realizar más evaluaciones.
                    </li>
                </ul>
                <DialogFooter>

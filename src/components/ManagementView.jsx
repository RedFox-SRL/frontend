...
const ManagementActions = ({ onSettingsClick, onEvaluationsClick, onRatingsClick, onProposalsClick }) => (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
        <Button onClick={onSettingsClick} className="w-full bg-purple-600 hover:bg-purple-700 text-white px-2 py-1 h-auto text-xs sm:text-sm md:text-base">
            <Settings className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" />
            <span>Configuración</span>
        </Button>
        <Button onClick={onEvaluationsClick} className="w-full bg-purple-600 hover:bg-purple-700 text-white px-2 py-1 h-auto text-xs sm:text-sm md:text-base">
            <Star className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" />
            <span>Plantillas de evaluaciones</span>
        </Button>
        <Button onClick={onRatingsClick} className="w-full bg-purple-600 hover:bg-purple-700 text-white px-2 py-1 h-auto text-xs sm:text-sm md:text-base">
            <Lightbulb className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" />
            <span>Resumen notas</span>
        </Button>
        <Button onClick={onProposalsClick} className="w-full bg-purple-600 hover:bg-purple-700 text-white px-2 py-1 h-auto text-xs sm:text-sm md:text-base">
    ...
    if (showRatingsPopup) {
        return (
            <RatingsView
                ...
                onUpdate={fetchManagementDetails} // Pass the onUpdate callback
            />
        );
    }

...
import {ArrowLeft, ChevronDown, ChevronUp, Users, HelpCircle, Loader2} from 'lucide-react';
...
const RatingView2 = ({onBack, managementId}) => {
    ...
    if (groups.length === 0) {
        return (<div className="flex flex-col items-center justify-center h-screen space-y-4">
            ...
            <Button
                variant="outline"
                className="text-purple-600 hover:bg-purple-100 flex items-center space-x-2"
                onClick={onBack}
            >

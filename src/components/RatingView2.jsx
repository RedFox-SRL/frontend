...
const RatingView2 = ({onBack, managementId}) => {
    ...
    return (<div className="bg-white overflow-auto p-4 sm:p-6">
        {loading ? (<div className="flex justify-center items-center h-full">Cargando...</div>) : (<>
            <Button
                variant="outline"
            ...
            <div
                ...
                <div className="w-full sm:w-auto">
                    <h3 className="text-purple-700 font-bold text-xl sm:text-2xl mb-2">Resumen de
                        Calificaciones</h3>
                </div>
                <Select
                    value={selectedGroup}
                        ...
                        <table className="w-full text-left text-sm">
                            ...
                            <tr className="border-b">
                                ...
                                <th className="py-2 text-purple-700">Sprints
                                    ({group.score_configuration.sprints}%)
                                </th>
                                <th className="py-2 text-purple-700">Propuesta
                                    ({group.score_configuration.proposal}%)
                                </th>
                                <th className="py-2 text-purple-700">Eval. Cruzada
                                    ({group.score_configuration.cross_evaluation}%)
                                </th>
            ...
            <Dialog open={!!selectedStudent} onOpenChange={closeModal}>
                <DialogContent
                    className="bg-white p-4 sm:p-6 rounded-lg w-[95vw] sm:w-[90vw] max-w-2xl mx-auto">
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg space-y-2 mb-6">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span
                                className="font-bold">{selectedStudent?.cross_evaluation_score.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between pt-2 border-t">
                            <span className="font-bold">Nota Final:</span>
                            <span
                                className="font-bold text-lg">{selectedStudent?.final_score.toFixed(2)}/100</span>
                        </div>
                    </div>

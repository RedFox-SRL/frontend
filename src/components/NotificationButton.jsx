...
const NotificationItem = React.memo(({notification, onDelete}) => (
    ...
    >
        <p className="text-sm text-gray-800 font-medium pr-6">{notification.message}</p>
...
const NotificationList = React.memo(({notifications, onDelete}) => (
    <div className="p-4 max-h-[60vh] overflow-y-auto">
        ...
        {notifications.length === 0 && (
            <p className="text-gray-600 text-center py-4">No tienes notificaciones nuevas.</p>
        )}
    </div>
));
    ...
    return (
        <div className="relative z-50">
            ...
            `}
                    ...
                    >
                        <div
                            className="bg-gradient-to-r from-purple-600 to-pink-500 rounded-lg shadow-lg overflow-hidden">
                            <div className="p-4">

...
import { Check, Copy, Mail, Phone, Users, X } from "lucide-react";
...
export default function GroupDetails({ group, onClose, getInitials }) {
  ...
  return (
    <Dialog open={!!group} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-[95vw] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px] p-0 overflow-hidden rounded-lg sm:rounded-xl bg-white [&>button]:hidden">

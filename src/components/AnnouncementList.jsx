...
export default function AnnouncementList({announcements}) {
            ...
            return (<div className="relative group overflow-hidden rounded-lg aspect-w-16 aspect-h-10">
                ...
                <div
                    ...
                    <a
                        ...
                        className="text-white text-sm font-medium rounded-md px-3 py-1"
                    >
                        Ver imagen
                    </a>
                </div>
    ...
    const renderNonPreviewFile = (file) => (
        <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-lg shadow-sm transition-shadow duration-200">
            <Paperclip className="h-5 w-5 text-purple-500 flex-shrink-0"/>
            <a
                href={file.url}
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-purple-700 truncate flex-grow rounded-md"
            >
                {file.name || "Archivo"}
            </a>
        </div>);
    ...
    return (<div className="container mx-auto px-4 py-8 space-y-6">
        ...
        </div>) : sortedAnnouncements.length > 0 ? (sortedAnnouncements.map((announcement) => {
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs sm:text-sm text-gray-500 flex items-center">
                                    ...
                                    Publicado el: {new Date(announcement.created_at).toLocaleDateString(undefined, {

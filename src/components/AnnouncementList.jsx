            ...
            <div className="flex flex-wrap gap-4">
                {videos.map((video, index) => (
                    <div
                        ...
                        className="flex flex-col items-center w-32 sm:w-40 space-y-1"
                    >
                        <a
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs sm:text-sm text-purple-700 hover:underline text-center"
                        >
                            {video.title}
                        </a>
                    </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <CardContent className="px-3 py-2">
                                ...
                                {announcement.youtube_videos?.length > 0 && (
                                    <div className="mt-2">{renderYouTubeVideos(announcement.youtube_videos)}</div>
                                )}

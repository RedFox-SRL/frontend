...
export default function ReportView({ groupId }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white-100 to-indigo-100 p-2 sm:p-4"> {/* Padding mínimo */}
            <div className="max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold text-purple-800 mb-4 text-center">Reportes de Evaluaciones</h1>

                {/* Tabs para navegación entre tipos de reportes */}
                <div className="bg-white shadow-lg rounded-lg p-2 sm:p-4 mb-4 w-full"> {/* Padding mínimo */}
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        <TabsList className="grid w-full grid-cols-4 bg-purple-100 rounded-md">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline ml-1 sm:ml-2">Reporte General</span>
                            </TabsTrigger>

...
const LoginPage = () => {
    ...
    return (
        <div
            className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-950 to-purple-950 animate-gradient-x p-4 relative">
            <Particles
                id="tsparticles"
                init={particlesInit}
            ...
            <div
                ...
                <div className="md:w-1/2 bg-black text-white p-8 flex flex-col justify-center">
                    ...
                    <p className="text-lg mb-6">¡Bienvenido!<br/>¿No tienes una cuenta? Crea una ahora mismo</p>
                    <button
                        type="button"

...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-fuchsia-950 via-purple-950 to-stone-950 animate-gradient-x p-4 relative">
      <Particles
        id="tsparticles"
        init={particlesInit}
      ...
      <div className="w-full max-w-4xl bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg flex flex-col md:flex-row overflow-hidden relative z-10">
        <div className="md:w-1/2 bg-black text-white p-8 flex flex-col justify-center">
          ...
          <p className="text-lg mb-6">
            ¡Bienvenido!
            <br />
            ¿No tienes una cuenta? Crea una ahora mismo
          </p>
          <button
            type="button"

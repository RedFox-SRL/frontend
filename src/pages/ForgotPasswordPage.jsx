...
const ForgotPasswordPage = () => {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      ...
      setError(
        "Error al enviar el correo de recuperación. Verifica el email ingresado.",
      );
      setSuccess(null);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-fuchsia-950 via-purple-950 to-stone-950 animate-gradient-x">
      <Particles
        id="tsparticles"
        init={particlesInit}

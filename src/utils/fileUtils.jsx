...
export const getFileIcon = (fileType) => {
    switch (fileType) {
        ...
        case 'audio': return <Music className="w-12 h-12 text-green-500"/>
        case 'pdf': return <FileText className="w-12 h-12 text-red-700"/>
        case 'word': return <FileText className="w-12 h-12 text-blue-700"/>
        case 'excel': return <FileText className="w-12 h-12 text-green-700"/>
        case 'powerpoint': return <FileText className="w-12 h-12 text-orange-700"/>
